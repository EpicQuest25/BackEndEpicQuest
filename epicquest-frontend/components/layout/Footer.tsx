...
const FooterSection = ({ title, children, className }: FooterSectionProps) => {
  return (
    <div className={cn('mt-8 md:mt-0', className)}>
      ...
      <div className="container mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="xl:grid xl:grid-cols-5 xl:gap-8">
          ...
          <div className="xl:col-span-2">
            ...
            <p className="mt-4 text-gray-500 text-sm max-w-xs">
              Your one-stop destination for booking hotels and flights. Find the best deals and plan your perfect trip with EpicQuest.
            </p>
          ...
          <div className="mt-12 grid grid-cols-2 gap-8 xl:col-span-3 xl:mt-0">
            ...
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <FooterSection title="Legal">
                ...
                <FooterLink href="/legal">Legal Notices</FooterLink>
              </FooterSection>
              <FooterSection title="Travel">
        ...
        <div className="mt-12 border-t border-gray-200 pt-8">
          <p className="text-sm text-gray-400 text-center">
            &copy; {new Date().getFullYear()} EpicQuest, Inc. All rights reserved.
          </p>
          <div className="mt-4 flex justify-center space-x-6">
            <FooterLink href="/sitemap">Sitemap</FooterLink>
            <FooterLink href="/cookies">Cookies</FooterLink>
            <FooterLink href="/choices">Your Privacy Choices</FooterLink>
          </div>
        </div>
      </div>
    </footer>
